...
import (
	...
	"github.com/douzengrui001/redis_operator/internal/controller"
	webhookk8sioredisv1 "github.com/douzengrui001/redis_operator/internal/webhook/v1"
...
func init() {
	...
	utilruntime.Must(k8sioredisv1.AddToScheme(scheme))
...
func main() {
	...
	webhookServer := webhook.NewServer(webhook.Options{
		TLSOpts:  tlsOpts,
		CertDir:  "/etc/webhook/certs", // 挂载路径
		CertName: "tls.crt",            // 证书文件名
		KeyName:  "tls.key",            // 私钥文件名
	})
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a5010c48.k8s.io.redis",
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = webhookk8sioredisv1.SetupClusterWebhookWithManager(mgr); err != nil {
	...
	// nolint:goconst
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = webhookk8sioredisv1.SetupReplicationWebhookWithManager(mgr); err != nil {
	...
	// nolint:goconst
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = webhookk8sioredisv1.SetupStandaloneWebhookWithManager(mgr); err != nil {
