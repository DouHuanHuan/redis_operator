...
// +kubebuilder:rbac:groups=k8s.io.redis,resources=replications,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=k8s.io.redis,resources=replications/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=k8s.io.redis,resources=replications/finalizers,verbs=update
