...
// +kubebuilder:rbac:groups=k8s.io.redis,resources=sentinels,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=k8s.io.redis,resources=sentinels/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=k8s.io.redis,resources=sentinels/finalizers,verbs=update
